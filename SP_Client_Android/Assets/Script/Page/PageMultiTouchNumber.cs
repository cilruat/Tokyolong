...
public class PageMultiTouchNumber : SingletonMonobehaviour<PageMultiTouchNumber>
{
    ...
    class Number
    {
        ...
        public PageMultiTouchNumber page;

        public Number(int num, Text txt, RawImage img, Button btn, GameObject obj, RectTransform rt, PageMultiTouchNumber page)
        {
            this.txt = txt;
            this.img = img;
            this.num = num;
