...
namespace SkyFlightGame
{
	...
	/// </summary>
	public class SFGGlobalMusic : MonoBehaviour 
	{
		...
		void  Awake()
		{
			...
			if ( musicObjects.Length > 1 )
			{
				...
				{
					if ( musicObject.GetComponent<SFGGlobalMusic>() && musicObject.GetComponent<SFGGlobalMusic>().instanceTime <= 0 )    Destroy(gameObject);
				}
			}
		}
