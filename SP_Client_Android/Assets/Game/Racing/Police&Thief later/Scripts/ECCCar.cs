...
namespace EndlessCarChase
{
    ...
    public class ECCCar : MonoBehaviour
    {
        ...
        [Tooltip("How wuickly the chassis returns to its straight angle after we stop turning")]
        ...
        public float speedVariation = 10;
        ...
        public float changeTargetChance = 0.03f;
