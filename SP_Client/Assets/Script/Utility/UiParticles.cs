...
namespace UiParticles
{
	...
	public class UiParticles : MaskableGraphic
	{
	    ...
	    /// <summary>
	    /// X position Velocity over lifemtime curve for streched billboards mode
	    /// </summary>
	    [FormerlySerializedAs ("m_VelocityOverLifetimeX")]
	    [SerializeField]
	    [Tooltip("X position Velocity over lifemtime curve for streched billboards mode ")]
	    private UiParticleMinMaxCurve m_VelocityOverLifetimeX;

	    /// <summary>
	    /// Y position Velocity over lifemtime curve for streched billboards mode
	    /// </summary>
	    [FormerlySerializedAs ("m_VelocityOverLifetimeY")]
	    [SerializeField]
	    [Tooltip("Y position Velocity over lifemtime curve for streched billboards mode ")]
	    private UiParticleMinMaxCurve m_VelocityOverLifetimeY;

	    /// <summary>
	    /// Z position Velocity over lifemtime curve for streched billboards mode
	    /// </summary>
	    [FormerlySerializedAs ("m_VelocityOverLifetimeZ")]
	    [SerializeField]
	    [Tooltip("Z position Velocity over lifemtime curve for streched billboards mode ")]
	    private UiParticleMinMaxCurve m_VelocityOverLifetimeZ;


	    /// <summary>
	    /// Frame over lifetime curve texture sheet animation
	    /// </summary>
	    [FormerlySerializedAs ("m_FrameOverLifetime")]
	    [SerializeField]
	    [Tooltip("Frame over lifetime curve texture sheet animation")]
	    private UiParticleMinMaxCurve m_FrameOverLifetime;
...
#else
	            var seed = (int) particle.randomSeed;
	            currVell.x = m_VelocityOverLifetimeX.Evaluate(timeAlive01, seed);
	            currVell.y = m_VelocityOverLifetimeY.Evaluate(timeAlive01, seed);
	            currVell.z = m_VelocityOverLifetimeZ.Evaluate(timeAlive01, seed);
#endif
	        }
