...
public class ScreenFaderSingleton : Singleton<ScreenFaderSingleton>
{
    ...
    /// scenes.
    /// </summary>
    public void FadeAndLoadSpecificLevel(int level)
    {
        Invoke("FadeOut", 1f);
    ...
    /// </summary>
    public void FadeAndLoadSpecificLevelFaster(int level)
    {
        Invoke("FadeOut", 0f);
    ...
    IEnumerator LoadSpecificLevel(float waitTime, int levelToLoad)
    {
